      ...
      <section style={{ marginBottom: '60px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '20px', marginBottom: '30px' }}>
          <div className="card">
            ...
            <p className="text text--bold">Primary</p>
            <p className="text text--sm text--muted">{theme.colors.primary}</p>
            <p className="text text--xs">var(--color-primary)</p>
          </div>
          <div className="card">
            <div style={{
              height: '80px',
            ...
            <p className="text text--bold">Primary Hover</p>
            <p className="text text--sm text--muted">{theme.colors.primaryHover}</p>
            <p className="text text--xs">var(--color-primary-hover)</p>
          </div>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '20px', marginBottom: '30px' }}>
          <div className="card">
            ...
            <p className="text text--bold">Secondary</p>
            <p className="text text--sm text--muted">{theme.colors.secondary}</p>
            <p className="text text--xs">var(--color-secondary)</p>
          </div>
          <div className="card">
            <div style={{
              height: '80px',
            ...
            <p className="text text--bold">Secondary Hover</p>
            <p className="text text--sm text--muted">{theme.colors.secondaryHover}</p>
            <p className="text text--xs">var(--color-secondary-hover)</p>
          </div>
          <div className="card">
            <div style={{
              height: '80px',
            ...
            <p className="text text--bold">Accent</p>
            <p className="text text--sm text--muted">{theme.colors.accent}</p>
            <p className="text text--xs">var(--color-accent)</p>
          </div>
          <div className="card">
            <div style={{
              height: '80px',
            ...
            <p className="text text--bold">Accent Hover</p>
            <p className="text text--sm text--muted">{theme.colors.accentHover}</p>
            <p className="text text--xs">var(--color-accent-hover)</p>
          </div>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '20px', marginBottom: '30px' }}>
          <div className="card">
            ...
            <p className="text text--bold">Success</p>
            <p className="text text--sm text--muted">{theme.colors.success}</p>
            <p className="text text--xs">var(--color-success)</p>
          </div>
          <div className="card">
            <div style={{
              height: '80px',
            ...
            <p className="text text--bold">Error</p>
            <p className="text text--sm text--muted">{theme.colors.error}</p>
            <p className="text text--xs">var(--color-error)</p>
          </div>
          <div className="card">
            <div style={{
              height: '80px',
            ...
            <p className="text text--bold">Warning</p>
            <p className="text text--sm text--muted">{theme.colors.warning}</p>
            <p className="text text--xs">var(--color-warning)</p>
          </div>
          <div className="card">
            <div style={{
              height: '80px',
            ...
            <p className="text text--bold">Info</p>
            <p className="text text--sm text--muted">{theme.colors.info}</p>
            <p className="text text--xs">var(--color-info)</p>
          </div>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '20px', marginBottom: '30px' }}>
          <div className="card">
            ...
            <p className="text text--bold">Background</p>
            <p className="text text--sm text--muted">{theme.colors.background}</p>
            <p className="text text--xs">var(--color-background)</p>
          </div>
          <div className="card">
            <div style={{
              height: '80px',
            ...
            <p className="text text--bold">Surface</p>
            <p className="text text--sm text--muted">{theme.colors.surface}</p>
            <p className="text text--xs">var(--color-surface)</p>
          </div>
          <div className="card">
            <div style={{
              height: '80px',
            ...
            <p className="text text--bold">Text</p>
            <p className="text text--sm text--muted">{theme.colors.text}</p>
            <p className="text text--xs">var(--color-text)</p>
          </div>
          <div className="card">
            <div style={{
              height: '80px',
            ...
            <p className="text text--bold">Text Secondary</p>
            <p className="text text--sm text--muted">{theme.colors.textSecondary}</p>
            <p className="text text--xs">var(--color-text-secondary)</p>
          </div>
          <div className="card">
            <div style={{
              height: '80px',
            ...
            <p className="text text--bold">Border</p>
            <p className="text text--sm text--muted">{theme.colors.border}</p>
            <p className="text text--xs">var(--color-border)</p>
          </div>
        </div>

        <div className="card card--bordered">
          <p className="text text--sm">
            💡 <span className="text text--bold">Tip:</span> All these colors are defined in <code>/src/config/theme.js</code> and automatically converted to CSS variables. Change the colors in theme.js to customize your brand palette.
          </p>
        </div>
      </section>
